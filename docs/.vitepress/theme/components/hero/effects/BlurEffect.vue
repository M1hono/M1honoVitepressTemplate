...
const animate = () => {
  ...
  if (props.animationType === 'pulse') {
    blurValue = props.minAmount + (props.maxAmount - props.minAmount) * Math.sin(progress * Math.PI * 2);
  } else if (props.animationType === 'wave') {
    blurValue = props.minAmount + (props.maxAmount - props.minAmount) * (Math.sin(progress * Math.PI * 4) * 0.5 + 0.5);
  } else if (props.animationType === 'breath') {
    blurValue = props.minAmount + (props.maxAmount - props.minAmount) * (Math.sin(progress * Math.PI) * 0.5 + 0.5);
  } else {
