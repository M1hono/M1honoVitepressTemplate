...
Use the `shader-effect` container to render custom GLSL shaders in your documentation.

- [Hero Section Enhancement with TresJS/Three.js](#hero-section-enhancement-with-tresjsthreejs)
  - [Overview](#overview)
  ...
  - [Dependencies](#dependencies)
    ...
    - [Existing Dependencies (Already Installed)](#existing-dependencies-already-installed)
  - [VitePress Setup](#vitepress-setup)
    - [Registering TresJS Components](#registering-tresjs-components)
    - [Client-Only Component Wrapper](#client-only-component-wrapper)
    - [Troubleshooting](#troubleshooting)
    - [Shader Effect Markdown Plugin](#shader-effect-markdown-plugin)
  - [Core Three.js/TresJS APIs](#core-threejstresjs-apis)
    - [✅ Shader Background API Support Confirmation](#-shader-background-api-support-confirmation)
    - [Three Essential APIs for This Framework](#three-essential-apis-for-this-framework)
      - [1. TresCanvas (Root Component)](#1-trescanvas-root-component)
      - [2. Animation: @loop Event vs useRenderLoop](#2-animation-loop-event-vs-userenderloop)
      - [3. useTres (Scene Context Composable)](#3-usetres-scene-context-composable)
    - [Additional Recommended APIs](#additional-recommended-apis)
      - [4. Tres Component System (Auto-mapped Three.js Components)](#4-tres-component-system-auto-mapped-threejs-components)
      - [5. Extend API (Custom Shaders and Three.js Components)](#5-extend-api-custom-shaders-and-threejs-components)
      - [6. @tresjs/cientos (Ready-to-Use Components)](#6-tresjscientos-ready-to-use-components)
    - [Three.js Core APIs (Direct Usage)](#threejs-core-apis-direct-usage)
  ...
  - [Background Configuration Modes](#background-configuration-modes)
    - [Single Layer Mode](#single-layer-mode)
    - [Multi-Layer Mode](#multi-layer-mode)
  - [Features](#features)
    - [1. Animated Sea Waves (Enhancement System)](#1-animated-sea-waves-enhancement-system)
    - [2. Background System](#2-background-system)
      - [2.1 Image Background](#21-image-background)
      - [2.2 Video Background](#22-video-background)
      - [2.3 Color Background](#23-color-background)
      - [2.4 Shader Background](#24-shader-background)
    - [3. Particle System](#3-particle-system)
    - [4. 3D Model Support](#4-3d-model-support)
    - [5. Motion Vue Integration](#5-motion-vue-integration)
    - [6. Background Animations](#6-background-animations)
      - [6.1 Parallax Effect](#61-parallax-effect)
      - [6.2 Blur Effect](#62-blur-effect)
      - [6.3 Bounce Effect](#63-bounce-effect)
    - [7. 3D Hover Effects](#7-3d-hover-effects)
    - [8. Button Styling System](#8-button-styling-system)
    - [9. Features Enhancement](#9-features-enhancement)
    - [10. Shader Template System](#10-shader-template-system)
    - [11. Internationalization (i18n) Support](#11-internationalization-i18n-support)
  - [Component Structure](#component-structure)
    - [Folder Organization](#folder-organization)
    - [Component Details](#component-details)
      - [VPHero.vue](#vpherovue)
      - [HeroBackground.vue](#herobackgroundvue)
      - [WaveAnimation.vue](#waveanimationvue)
      - [BackgroundLayer.vue](#backgroundlayervue)
      - [HeroActions.vue](#heroactionsvue)
      - [Hover3DEffect.vue](#hover3deffectvue)
      - [Model3D.vue](#model3dvue)
  - [Implementation Guidelines](#implementation-guidelines)
    - [1. TresJS Setup](#1-tresjs-setup)
    - [2. Component Development](#2-component-development)
    - [3. Performance Optimization](#3-performance-optimization)
    - [4. Composables and Utils](#4-composables-and-utils)
      - [useSafeI18n (from utils/i18n/locale)](#usesafei18n-from-utilsi18nlocale)
      - [useBackgroundAnimation.ts](#usebackgroundanimationts)
      - [useParallax.ts](#useparallaxts)
      - [useBlurEffect.ts](#useblureffectts)
      - [useBounceEffect.ts](#usebounceeffectts)
      - [useHover3D.ts](#usehover3dts)
    - [5. Responsive Design](#5-responsive-design)
    - [5. Accessibility](#5-accessibility)
    - [6. Theme Support](#6-theme-support)
  - [Examples](#examples)
    - [Example 1: Single Layer Color Background with Wave Enhancement](#example-1-single-layer-color-background-with-wave-enhancement)
    - [Example 2: Shader Background with Particles and Waves](#example-2-shader-background-with-particles-and-waves)
    - [Example 3: 3D Model Hero Image](#example-3-3d-model-hero-image)
    - [Example 4: Multi-Layer Background with Video and Gradient Overlay](#example-4-multi-layer-background-with-video-and-gradient-overlay)
    - [Example 4b: Single Layer Mode (Simpler)](#example-4b-single-layer-mode-simpler)
    - [Example 5: Custom Shader Background with Template](#example-5-custom-shader-background-with-template)
    - [Example 6: Hero with 3D Hover Buttons and Features](#example-6-hero-with-3d-hover-buttons-and-features)
    - [Example 7: Multi-Layer Background with URLs and Theme Variation](#example-7-multi-layer-background-with-urls-and-theme-variation)
  - [Migration Guide](#migration-guide)
    - [From Current Hero to Enhanced Hero](#from-current-hero-to-enhanced-hero)
  - [Browser Support](#browser-support)
  - [Performance Considerations](#performance-considerations)
  - [Shader Template Registration](#shader-template-registration)
    - [Creating a Custom Shader Template](#creating-a-custom-shader-template)
  - [Background Layers Design Benefits](#background-layers-design-benefits)
    - [Type Safety](#type-safety)
    - [Flexibility](#flexibility)
    - [Maintainability](#maintainability)
    - [Performance](#performance)
    - [Developer Experience](#developer-experience)
  - [URL and Theme Variation Support](#url-and-theme-variation-support)
    - [URL Support](#url-support)
    - [Theme Variation Support](#theme-variation-support)
  - [Summary of Key Features](#summary-of-key-features)
    ...
    - [✅ Folder Structure](#-folder-structure)
    - [✅ Waves Enhancement System](#-waves-enhancement-system)
    - [✅ Color Format](#-color-format)
    - [✅ Shader Templates](#-shader-templates)
    - [✅ Button Styling](#-button-styling)
    - [✅ Features Enhancement](#-features-enhancement)
    - [✅ 3D Hover Effects](#-3d-hover-effects)
    - [✅ Internationalization](#-internationalization)
  - [Future Enhancements](#future-enhancements)
**Status**: Finished

**Basic Usage with Custom Shaders**:
...
void main() {
  ...
  float ring = smoothstep(0.9, 0.15, r);
...
```md
::: shader-effect{"preset":"ocean","speed":1.2}
Uses ocean preset colors if no custom shaders provided.
:::
```

**Live Preview (Black Hole)**:
...
**Config options**:
- `preset`: `wave` | `ocean` | `sunset` | `mono` (fallback palette)
- `speed`: Animation speed multiplier (default: `1`)
- `paused`: Start with animation paused (default: `false`)

**Notes**:
- Size auto-adjusts to container width with 16:9 aspect ratio
- Shader background uses `uBgColor` so it blends with the page theme

**Supported Code Block Languages**:
- `glsl` - Auto-detects vertex (contains `gl_Position`) vs fragment (contains `gl_FragColor`)
- `glsl-vertex` or `vertex` - Vertex shader
- `glsl-fragment` or `fragment` - Fragment shader

**Available Uniforms** (auto-injected):
- `uTime` - Elapsed time in seconds
- `uBgColor` - Background color derived from theme
- `uThemeIsDark` - Theme flag (0 for light, 1 for dark)
- `uColor1`, `uColor2`, `uColor3` - Preset color vectors
...
#### 2. Animation: @loop Event vs useRenderLoop

**⚠️ Important**: There are two ways to handle render loop animations:

**Recommended: @loop Event** (Simpler, no injection issues)
```vue
<template>
  <TresCanvas @loop="handleLoop">
    <!-- 3D content -->
  </TresCanvas>
</template>

<script setup lang="ts">
const uniforms = ref({ uTime: { value: 0 } });
...
**Alternative: useRenderLoop Composable** (More control, but requires careful setup)
```typescript
import { useRenderLoop } from '@tresjs/core';

// MUST call in setup() synchronously, NOT conditionally
const { onLoop, resume, pause } = useRenderLoop();

// Register callback immediately in setup
...
**⚠️ Common Errors**:
- ❌ Calling `useRenderLoop()` conditionally or after setup phase
- ❌ Registering `onLoop()` callback in async functions or event handlers
- ✅ Call `useRenderLoop()` and `onLoop()` synchronously in `setup()`
