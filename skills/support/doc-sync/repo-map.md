...
Default layout assumed by the sync tool:
...
- `docs/src/en-US/frontmatter/reference/chartAuthoring.md`
- `docs/src/zh-CN/frontmatter/reference/chartAuthoring.md`
- `docs/src/en-US/frontmatter/reference/mermaidAuthoring.md`
- `docs/src/zh-CN/frontmatter/reference/mermaidAuthoring.md`
...
- `docs/en/doc/chartAuthoring.md`
- `docs/zh/doc/chartAuthoring.md`
- `docs/en/doc/mermaidAuthoring.md`
- `docs/zh/doc/mermaidAuthoring.md`
...
- Keep the meaning of the developer-doc entry points aligned: maintainability guide, development workflow, extension architecture, hero extension, chart authoring, Mermaid authoring, and the surrounding reference pages.
